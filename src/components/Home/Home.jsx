...
const Home = () => {
    ...
    return (
        <section
            ...
            data-aos-delay="1000"
            data-aos-duration="3000" className="lg:my-auto ">
                {/* <FaGithub className="border "></FaGithub> */}
                    <img id="image1" className="border-8 border-black p-2 lg:w-96 lg:h-96 md:w-72 md:h-72 w-60 h-60 rounded-full object-cover " src={myimage} alt="" />
                </div>
            ...
            data-aos-duration="3000" className="lg:my-auto ">
                    ...
                    <p  className="lg:text-6xl md:text-4xl text-3xl mb-5 font-bold flex gap-2 text-white">
                      - I'm  <p id="name">Mahmud Hasan</p><span className="" id="zoom">.</span>
                    </p>
                    
                    </div>
                    <div className="lg:text-5xl md:text-3xl text-2xl font-extrabold relative lg:w-96 ">
